...
async function getArticle(slug: string) {
    const NEXT_PUBLIC_API = process.env.NEXT_PUBLIC_API;
    const res = await fetch(`${NEXT_PUBLIC_API}/articles/find-by-slug/${slug}?category=news`);
    if (!res.ok) {
    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:url" content={`https://sinhphuctho.com/cam-nang/${article.slug}.html`} />
